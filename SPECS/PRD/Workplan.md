...
| P0.4 | CI pipeline (build + test) | Medium | P0.3 | Automated CI | [x] **COMPLETED** |
...
| P1.3 | Implement preset mapping | High | P1.2 | — | Preset configuration table | [x] **COMPLETED** |
| P1.4 | Slider → params mapping | High | P1.3 | — | UI mapping function | [x] **COMPLETED** |
